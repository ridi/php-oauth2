<?php
namespace Ridibooks\OAuth2Resource\Client;

use InvalidArgumentException;
use Ridibooks\OAuth2Resource\Client\Constant\OAuth2GrantType;
...
use Ridibooks\OAuth2Resource\Client\DataTransferObject\TokenData;
use Ridibooks\OAuth2Resource\Client\Exception\InvalidResponseException;
use Ridibooks\OAuth2Resource\Client\Exception\OAuthFailureException;
...
class Grant
{
    ...
    {
        $data = $this->getDefaultTokenData(OAuth2GrantType::AUTHORIZATION_CODE);
        $data['code'] = $code;
    ...
    {
        $data = $this->getDefaultTokenData(OAuth2GrantType::REFRESH_TOKEN);
