<?php
namespace Ridibooks\OAuth2Resource\Symfony;
...
use Ridibooks\OAuth2Resource\Symfony\Exception\WrongInstanceException;
...
class MiddlewareFactory
{
    ...
    public static function introspect(JwtInfo $jwt_info): Callable
    {
        ...
        return function (Request $request) use ($jwt_info) {
            ...
            } catch (\Ridibooks\OAuth2Resource\Introspector\Exception\InvalidJwtSignatureException $e) {
                throw new InvalidJwtSignatureException();
            } catch (\Ridibooks\OAuth2Resource\Introspector\Exception\ExpireTokenException $e) {
